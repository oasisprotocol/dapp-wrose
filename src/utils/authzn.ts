// authzn-sdk not released yet

const DEFAULT_TIMEOUT = 300000 // 5min

const { VITE_BASE_AUTH_URL } = import.meta.env

const authOrigin = VITE_BASE_AUTH_URL ?? 'https://playground.oasis.io'
...
const handlePopup = <T>(
  ...
  const strWindowFeatures = 'toolbar=no, menubar=no, width=1280, height=800, top=100, left=100'
